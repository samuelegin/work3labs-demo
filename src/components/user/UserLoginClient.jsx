...
export default function UserLoginClient() {
  ...
  const [email, setEmail] = useState('alex@work3labs.io')
  ...
  return (
    ...
    >
      ...
      {/* DEMO BANNER */}
      <div className="fixed top-0 left-0 right-0 z-40 bg-green-dark text-ink px-4 py-2 flex items-center justify-center gap-3">
        <i className="bi bi-lightning-charge-fill text-[13px]" />
        <span className="font-sans text-[12.5px] font-medium">Demo mode — credentials are pre-filled. Just click Sign in.</span>
        <span className="font-mono text-[10px] opacity-60">alex@work3labs.io / demo1234</span>
      </div>
      <div className="h-9" />
      {/*
        ...
        <img src="/images/success-hero.png"
